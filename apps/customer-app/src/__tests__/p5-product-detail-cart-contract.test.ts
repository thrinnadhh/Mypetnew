...
function canonical(currentProduct: CommerceProduct) {
  return {
    ...
    organizationId: currentProduct.organizationId ?? '33333333-3333-4333-8333-333333333333',
    outletId: currentProduct.outletId ?? currentProduct.providerId,
    outletName: currentProduct.providerName,
    name: currentProduct.name,
    kind: currentProduct.kind ?? 'PRODUCT',
    category: currentProduct.category,
    brand: currentProduct.brand ?? null,
    petType: null,
    lifeStage: null,
    packLabel: currentProduct.packLabel ?? currentProduct.variants[0]?.name ?? null,
    ...
    currency: 'INR',
    commerceMode: currentProduct.commerceMode ?? 'COMMERCE',
    availableQuantity: currentProduct.availableQuantity ?? currentProduct.stockCount,
    pickupEnabled: currentProduct.pickupEnabled ?? true,
