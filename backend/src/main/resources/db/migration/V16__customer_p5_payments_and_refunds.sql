...
CREATE TABLE mypet.payment (
    ...
    provider_order_reference VARCHAR(64) NOT NULL,
    ...
    initiation_request_fingerprint VARCHAR(64) NOT NULL,
    ...
    CONSTRAINT uq_payment_customer_command UNIQUE (customer_id, initiation_idempotency_key),
...
CREATE INDEX idx_payment_reconciliation
    ON mypet.payment (reconciliation_required, next_reconciliation_at);
...
CREATE INDEX idx_payment_refund_retry
    ON mypet.payment_refund (reconciliation_required, next_reconciliation_at);
